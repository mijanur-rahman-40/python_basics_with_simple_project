...
"""A folder be a package folder in python when a __init__.py also be include in the folder. so when a folder or sub
folder is created then also include the __init__.py file always.But nothing have to written into __init__.py file"""
